...
With a background in biomedical laboratory science, I bring analytical thinking, structure and attention to detail into development. I’m especially interested in the connection between technology, design and user experience. 
...
|---|---|
| Frontend | [![Frontend](https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,tailwind,vite)](https://skillicons.dev) |
| Backend | [![Backend](https://skillicons.dev/icons?i=php,nodejs,express,cs,laravel)](https://skillicons.dev) |
| Database | [![Database](https://skillicons.dev/icons?i=mysql,mongodb,sqlite)](https://skillicons.dev) |
...
<!--
**Patricia-LF/Patricia-LF** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
